...
public class ToleranceUnit{
    ...
    /**
     * the actual tollerance
     */
	private double value;
    /**
     * tolerance in Dalton regardless of what the user set
     */
	private double bd_value; 
	/**
     * the assigned unit
     */
	private String unit;
	...
	public ToleranceUnit(double value, String unit){
		this.value = value;
		this.unit = unit;
		// this.bd_value = new double(value);
		//this.window = "";

		if(unit.equalsIgnoreCase("ppm")){
			// parts per million
			this.bd_value = Util.ONE_PPM * value;
            m_relativeUnit = true;
    ...
    /**
     * returns the specified tolerance in da
     * @return
     */
	public double getBigDRep(){return bd_value;}
    ...
    /**
     * sets the tolerance to a new value
     * @param v
     */
    public void   setBigDRep(double v){
        bd_value = v;
		if(unit.equalsIgnoreCase("ppm")){
			// parts per million
			this.value = v / Util.ONE_PPM;
		}else{
			// Dalton value
			this.value =  v;
		}
     ...
     *
     * it's made final - since at least during proviling that reduced the time spent here by 1/5th
     * but might be different on real-time conditions
     * @param value1
     * @param value2
     * @return &lt;0: value1 + tolerance &lt; value2 <br/> =0:value1 - tolerance &lt;= value2 &lt;= value1 + tolerance <br/> &gt;0: value1 - tolerance &gt;= value2
     *
     */
...
//                tolerance = value2 * Util.ONE_PPM * value;
    ...
    public final int  compareDoubleError(double value1, double value2) {
        ...
        double min1 = getMinRange(value1);
        double min2 = getMinRange(value2);
        double max1 = getMaxRange(value1);
        double max2 = getMaxRange(value2);
    ...
    /**
     * what is the smallest value the given value could represent (v - tolerance)
     * @param v
    ...
    /**
     * what is the smallest value the given value could represent (v - tolerance)
     * under the condition, that the tolerance is based on a different value.<br/>
    ...
    /**
     * calculates the error between the two values.
     * If the error unit is Da then it just returns the difference. For ppm 
     * it will return the ppm value.
