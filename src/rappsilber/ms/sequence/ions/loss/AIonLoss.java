 ...
 */
public class AIonLoss extends Loss{
...
//    }
    ...
    public static boolean register() {
        try {
            Loss.registerLossClass(AIonLoss.class);
        } catch (NoSuchMethodException ex) {
            Logger.getLogger(AIonLoss.class.getName()).log(Level.SEVERE, null, ex);
            return false;
        }
        return true;
    }
