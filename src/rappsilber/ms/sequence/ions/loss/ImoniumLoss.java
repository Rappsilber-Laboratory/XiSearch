...
public class ImoniumLoss extends Loss{
     ...
     */
    public ImoniumLoss(Fragment f) {
        super(f, -(Util.CARBON_MASS + Util.OXYGEN_MASS), m_LossID);
    }


    @Override
    public String name() {
        return getParentFragment().name() + "_a-ion";
    }
...
//    }
    ...
    public static boolean register() {
        try {
            Loss.registerLossClass(ImoniumLoss.class);
        } catch (NoSuchMethodException ex) {
            Logger.getLogger(ImoniumLoss.class.getName()).log(Level.SEVERE, null, ex);
            return false;
        }
        return true;
    }
