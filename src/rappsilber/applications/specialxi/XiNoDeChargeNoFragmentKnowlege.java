 ...
 */
public class XiNoDeChargeNoFragmentKnowlege extends SimpleXiProcessLinearIncluded {
    
    public XiNoDeChargeNoFragmentKnowlege(File fasta, AbstractSpectraAccess input, ResultWriter output, RunConfig config, StackedSpectraAccess filter) {
    ...
    public XiNoDeChargeNoFragmentKnowlege(SequenceList fasta, AbstractSpectraAccess input, ResultWriter output, RunConfig config, StackedSpectraAccess filter) {
        super(fasta, input, output, config, filter);
        System.out.println(this.getClass().getSimpleName());
