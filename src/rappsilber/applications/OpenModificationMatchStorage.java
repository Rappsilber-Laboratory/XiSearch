 ...
 */
public class OpenModificationMatchStorage extends SimpleXiProcessLinearIncluded{
...
//    private HashMap<AminoAcid,ModificationLookup> m_KnownModifications;
    ...
    public OpenModificationMatchStorage(File fasta, AbstractSpectraAccess input, ResultWriter output, RunConfig config, StackedSpectraAccess filter) {
    ...
    public OpenModificationMatchStorage(SequenceList fasta, AbstractSpectraAccess input, ResultWriter output, RunConfig config, StackedSpectraAccess filter) {
        super(fasta, input, output, config, filter);
    ...
    protected void fragmentTree() {
        ...
        Logger.getLogger(this.getClass().getName()).log(Level.INFO, "Build Fragment Tree");
        long max_peptides = m_config.retrieveObject("MAX_PEPTIDES", Long.MAX_VALUE);
        m_Fragments = new rappsilber.ms.lookup.fragments.FragmentTreeSlimedMTv2(m_peptides, max_peptides, null, getSequenceList(), getCPUs(), getConfig());
    }
    ...
    public void prepareSearch() {
        try {
            ...
            Logger.getLogger(OpenModificationMatchStorage.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//                        System.out.println("reduced to Last MGX index : " + lastMGXIndex);
            ...
            Logger.getLogger(OpenModificationMatchStorage.class.getName()).log(Level.SEVERE, "Error while processing spectra", e);
...
//                if (m_searchThreads[i].isAlive()) {
//                    try {
//                        m_searchThreads[i].join(1000);
//
//
//                    } catch (InterruptedException ex) {
//                        Logger.getLogger(SimpleXiProcess.class.getName()).log(Level.WARNING, "Interrupt while wating for thread to finish", ex);
//                    }
//                }
//            }
//
//            m_config.getStatusInterface().setStatus("Processed:" + m_msmInput.countReadSpectra() + " of " + m_msmInput.getSpectraCount());
...
//        m_running = false;
//        Logger.getLogger(SimpleXiProcess.class.getName()).log(Level.INFO, "Search Finished");
//
////        // wait for any output-buffer to empty out
//
//        while (BufferedResultWriter.hasActiveBuffer()) {
//            try {
//                Thread.sleep(500);
//            } catch (InterruptedException ex) {
//            }
...
//        System.err.println("not freed spectra");
//        try {
//            Thread.sleep(10000);
//        } catch (InterruptedException ex) {
//            Logger.getLogger(SimpleXiProcess.class.getName()).log(Level.SEVERE, null, ex);
//        }
//        for (int i = 0; i < Spectra.m_SpectraPoolUsed.size(); i++) {
//            Spectra s = Spectra.m_SpectraPoolUsed.get(i);
//            System.err.println("====================");
//            System.err.println("Spectra: " + s.getSource() + " -> " + s.getRun() + " -> " + s.getScanNumber());
//            for (StackTraceElement ste : s.m_creation) {
//                System.err.println(ste.toString());
//            }
//
//        }
//        System.err.println("*********************");
//        System.err.println("non freed spectra : " + Spectra.m_SpectraPoolUsed.size());
//        System.err.println("*********************");
