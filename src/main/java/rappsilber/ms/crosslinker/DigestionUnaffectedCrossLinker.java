 ...
 */
public class DigestionUnaffectedCrossLinker extends AminoAcidRestrictedCrossLinker {
     ...
     */
    public DigestionUnaffectedCrossLinker(String Name, double BaseMass, double CrossLinkedMass, HashSet<AminoAcid> PrimaryLinkableAminoAcids, HashSet<AminoAcid> SecondaryLinkableAminoAcids) {
     ...
     * @param primaryLinkableAminoAcids
     */
    public DigestionUnaffectedCrossLinker(String Name, double BaseMass, double CrossLinkedMass, HashMap<AminoAcid,Double> PrimaryLinkableAminoAcids, HashMap<AminoAcid,Double> SecondaryLinkableAminoAcids) {
        super(Name, BaseMass, CrossLinkedMass, PrimaryLinkableAminoAcids);
     ...
     * @return
     */
    public static DigestionUnaffectedCrossLinker parseArgs(String args, RunConfig config) throws ConfigurationParserException, ParseException {
        String Name = null;
        ...
        if (Name == null || BaseMass == Double.NEGATIVE_INFINITY ||
            ...
            throw new ConfigurationParserException("Config line does not describe a valid " + DigestionUnaffectedCrossLinker.class.getName());
        }
        if (losses != null) {
        ...
        DigestionUnaffectedCrossLinker cl = new DigestionUnaffectedCrossLinker(Name, BaseMass, CrossLinkedMass, primaryLinkableAminoAcids, secondaryLinkableAminoAcids);
