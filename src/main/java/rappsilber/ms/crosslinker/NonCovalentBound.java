 ...
 */
public class NonCovalentBound extends CrossLinker{


    public NonCovalentBound() {
        this("NonCovalent");
    }

    public NonCovalentBound(String name) {
        super(name, 0d, 0d);
    }
     ...
     * @return
     */
    public static NonCovalentBound parseArgs(String args) {
        return new NonCovalentBound();
    }
     ...
     * @return
     */
    public static NonCovalentBound parseArgs(String args, RunConfig config) {
        String name = "NonCovalent";
        int dbid =1;
        ...
        NonCovalentBound dxl =  new NonCovalentBound(name);
        dxl.setDBid(dbid);
        return dxl;
    }
