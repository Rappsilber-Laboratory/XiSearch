 ...
 */
public class IntensityWeightedError extends AbstractScoreSpectraMatch{
    ...
    public IntensityWeightedError(RunConfig config) {
    ...
    public double score(MatchedXlinkedPeptide match) {
        ...
        MatchedFragmentCollection mfc = match.getPrimaryMatchedFragments();
