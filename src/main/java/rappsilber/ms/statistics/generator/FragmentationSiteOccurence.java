...
public class FragmentationSiteOccurence extends AbstractStatistic {
     ...
     * @param maxLoss
     */
    public FragmentationSiteOccurence(Class IncludeFragmentClass, boolean countSitesOnly, int maxLoss) {
        this(countSitesOnly);
        m_IncludeFragmentClass = IncludeFragmentClass;
    }

    public FragmentationSiteOccurence(Class IncludeFragmentClass, Class ExcludeFragments, boolean countSitesOnly, boolean MustHaveBaseFragment, boolean CanHaveBaseFragment, int maxLossCount) {
    ...
    public FragmentationSiteOccurence(Class IncludeFragmentClass, Class ExcludeFragments, boolean countSitesOnly) {
        this(IncludeFragmentClass, countSitesOnly,0);
        m_IncludeFragmentClass = IncludeFragmentClass;
    }

    public FragmentationSiteOccurence(boolean countSitesOnly) {
        init();
