 ...
 */
public class StreamingAverageMedianStdDev extends StreamingMedianEstimator {
    ...
    double m_min = Double.MAX_VALUE;
    double m_max = Double.MIN_VALUE;
    HashMap<Thread,values> threadedVlaues = new HashMap<Thread, values>();

    public StreamingAverageMedianStdDev() {
    }

    public StreamingAverageMedianStdDev(double medianResolution) {
        super(medianResolution);
    }

    public StreamingAverageMedianStdDev(double medianResolution, int maxMedianBins) {
