...
// </editor-fold> 
public class ZIon extends Fragment {
    ...
    // </editor-fold> 
    public ZIon (Peptide peptide,int residue) {
        super(peptide, 
                (short)residue,
                (short)(peptide.length() - residue),
                -Util.NITROGEN_MASS - Util.HYDROGEN_MASS+Util.OXYGEN_MASS);
    }
...
//    }
    ...
    public static boolean register() {
        try {
            Fragment.registerFragmentClass(ZIon.class);
        } catch (NoSuchMethodException ex) {
            Logger.getLogger(ZIon.class.getName()).log(Level.SEVERE, null, ex);
            return false;
        }
        return true;
    }
