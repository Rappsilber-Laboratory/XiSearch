...
public class XiNoDeIsotopNoFragmentKnowlege extends SimpleXiProcessLinearIncluded {
    ...
    public XiNoDeIsotopNoFragmentKnowlege(File fasta, AbstractSpectraAccess input, ResultWriter output, RunConfig config, StackedSpectraAccess filter) {
    ...
    public XiNoDeIsotopNoFragmentKnowlege(SequenceList fasta, AbstractSpectraAccess input, ResultWriter output, RunConfig config, StackedSpectraAccess filter) {
        super(fasta, input, output, config, filter);
        System.out.println(this.getClass().getSimpleName());
